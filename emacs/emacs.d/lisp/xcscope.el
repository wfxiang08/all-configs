...
;; * Keybindings:
;;
;; All keybindings use the "C-c C-s" prefix, but are usable only while
;; editing a source file, or in the cscope results buffer:
;;
;;      C-c C-s s         Find symbol.
;;      C-c C-s d         Find global definition.
;;      C-c C-s g         Find global definition (alternate binding).
;;      C-c C-s c         Find functions calling a function.
;;      C-c C-s C         Find called functions (list functions called
;;                      from a function).
;;      C-c C-s t         Find text string.
;;      C-c C-s e         Find egrep pattern.
;;      C-c C-s f         Find a file.
;;      C-c C-s i         Find files #including a file.
;;
;; These pertain to cscope database maintanance:
;;
;;      C-c C-s L         Create list of files to index.
;;      C-c C-s I         Create list and index.
;;      C-c C-s E         Edit list of files to index.
;;      C-c C-s W         Locate this buffer's cscope directory
;;                      ("W" --> "where").
;;      C-c C-s S         Locate this buffer's cscope directory.
;;                      (alternate binding: "S" --> "show").
;;      C-c C-s T         Locate this buffer's cscope directory.
;;                      (alternate binding: "T" --> "tell").
;;      C-c C-s D         Dired this buffer's directory.
;;
;;
;; * Advanced usage:
;;
...
(if cscope:map
  ...
  (define-key cscope:map "\C-c\C-ss" 'cscope-find-this-symbol)
  (define-key cscope:map "\C-c\C-sd" 'cscope-find-global-definition)
  (define-key cscope:map "\C-c\C-sg" 'cscope-find-global-definition)
  (define-key cscope:map "\C-c\C-sc" 'cscope-find-functions-calling-this-function)
  (define-key cscope:map "\C-c\C-sC" 'cscope-find-called-functions)
  (define-key cscope:map "\C-c\C-st" 'cscope-find-this-text-string)
  (define-key cscope:map "\C-c\C-se" 'cscope-find-egrep-pattern)
  (define-key cscope:map "\C-c\C-sf" 'cscope-find-this-file)
  (define-key cscope:map "\C-c\C-si" 'cscope-find-files-including-file)
  ;;
  (define-key cscope:map "\C-c\C-sL" 'cscope-create-list-of-files-to-index)
  (define-key cscope:map "\C-c\C-sI" 'cscope-index-files)
  (define-key cscope:map "\C-c\C-sE" 'cscope-edit-list-of-files-to-index)
  (define-key cscope:map "\C-c\C-sW" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-c\C-sS" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-c\C-sT" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-c\C-sD" 'cscope-dired-directory))
...
Push current point on mark ring and select the entry window."
  ...
  (let ((file (get-text-property (point) 'cscope-file))
        (line-number (get-text-property (point) 'cscope-line-number)) window)
...
(defun cscope-help ()
  (interactive)
  (message
   (format "s=%s, g=%s, c=%s, C=%s, t=%s, e=%s, f=%s, n/p [LIEWSTD]"
           "symbol"
           "global"
           "calling"
           "called"
